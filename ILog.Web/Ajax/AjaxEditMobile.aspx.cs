...
{
    public partial class AjaxEditMobile : BaseWebPage
    {
        /// <summary>
        /// 手机验证码
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPost)
            {
                ...
                {
                    infoScript = "<script type=\"text/javascript\">window.parent.showmsg('手机验证码输入错误！');</script>";
                    return;
                }
                ...
                infoScript = "<script type=\"text/javascript\">window.parent.closeMobileDialog('" + mobile + "','保存成功！');</script>";
