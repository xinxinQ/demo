<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxJobProperty.aspx.cs"
    Inherits="ILog.Web.Ajax.AjaxJobProperty" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../js/jobproperty.js" type="text/javascript"></script>
...
<body>
    <div style="width: 100%; height: 100%">
        <h1 class="WindowTil G4 F14">
            <a href="javascript:window.parent.closeJobDialog(0,'','','',0,0,0);">
                <img class=" R Img" src="http://simg.instrument.com.cn/ilog/blue/images/Win_x.gif"
                    alt="关闭" /></a>选择工作性质</h1>
        <div class="Hr_20">
        </div>
        <form id="form_JobP" name="form_JobP" method="post" action="AjaxJobProperty.aspx">
        <%=strbHtml.ToString() %>
        </form>
    </div>
</body>
