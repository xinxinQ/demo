<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaContent.aspx.cs" Inherits="ILog.Web.TaContent" %>
...
<head>
    ...
    <script src="js/tacontent.js" type="text/javascript" language="javascript"></script>
...
<body class="body">
    ...
    <div class=" Area_B BrWh">
        ...
        <div class="Center L">
            ...
            <div class="Centent">
                <div>
                    <p class="F14 G6 L26">
                        ...
                        <div class="L Pl10">
                            <div class="GuanZ G9" id="HpersionConcern">
                            </div>
                    </p>
                </div>
            </div>
            ...
            <input id="hidNickname" type="hidden" value="<%=nickname %>" />
